...
| `032_completed_event_editions_mv.sql` | MV export.completed_event_editions + refresh helper (superseded by 034) |
| `033_edition_location_baseline.sql` | Edition location baseline table + export view + seed |
| `034_completed_event_editions_view.sql` | export.completed_event_editions as live VIEW (drops MV + refresh) |
<!-- /docs-sync:migration-index -->
